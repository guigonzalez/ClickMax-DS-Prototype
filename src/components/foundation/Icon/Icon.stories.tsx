...
export const TextColors: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 bg-interactive-action-default p-2 rounded">
        <Icon icon={User} color="primary" />
        <span className="text-sm text-text-primary">action bg</span>
      </div>
    </div>
  ),
};
